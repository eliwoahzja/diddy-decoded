...
.method private serializeCollection(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/util/Collection;)V
    .locals 1
    ...
    .line 116
    invoke-virtual {p1}, Lio/sentry/JsonObjectWriter;->beginArray()Lio/sentry/vendor/gson/stream/JsonWriter;
    ...
    .line 120
    :cond_0
    invoke-virtual {p1}, Lio/sentry/JsonObjectWriter;->endArray()Lio/sentry/vendor/gson/stream/JsonWriter;

    return-void
.end method

.method private serializeDate(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/util/Date;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p1, p3}, Lio/sentry/JsonObjectWriter;->value(Ljava/lang/String;)Lio/sentry/vendor/gson/stream/JsonWriter;
    :try_end_0
    ...
    .line 98
    invoke-virtual {p1}, Lio/sentry/JsonObjectWriter;->nullValue()Lio/sentry/vendor/gson/stream/JsonWriter;

    return-void
.end method

.method private serializeMap(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/util/Map;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private serializeTimeZone(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/util/TimeZone;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public serialize(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p2}, Lio/sentry/JsonObjectWriter;->value(Z)Lio/sentry/vendor/gson/stream/JsonWriter;
    ...
    invoke-virtual {p1, p3}, Lio/sentry/JsonObjectWriter;->value(Ljava/lang/Number;)Lio/sentry/vendor/gson/stream/JsonWriter;
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/sentry/JsonObjectSerializer;->serializeDate(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/util/Date;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/sentry/JsonObjectSerializer;->serializeTimeZone(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/util/TimeZone;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/sentry/JsonObjectSerializer;->serializeCollection(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/sentry/JsonObjectSerializer;->serializeMap(Lio/sentry/JsonObjectWriter;Lio/sentry/ILogger;Ljava/util/Map;)V
