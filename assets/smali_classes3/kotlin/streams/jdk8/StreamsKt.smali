...
.method public static final asStream(Lkotlin/sequences/Sequence;)Ljava/util/stream/Stream;
    ...
    invoke-static {v0, p0, v1}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/function/Supplier;IZ)Ljava/util/stream/Stream;
...
.method private static final asStream$lambda$4(Lkotlin/sequences/Sequence;)Ljava/util/Spliterator;
    ...
    invoke-static {p0, v0}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Iterator;I)Ljava/util/Spliterator;
...
.method public static final toList(Ljava/util/stream/DoubleStream;)Ljava/util/List;
    ...
    .line 96
    invoke-static {p0}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/DoubleStream;)[D
...
.method public static final toList(Ljava/util/stream/IntStream;)Ljava/util/List;
    ...
    .line 80
    invoke-static {p0}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/IntStream;)[I
...
.method public static final toList(Ljava/util/stream/LongStream;)Ljava/util/List;
    ...
    .line 88
    invoke-static {p0}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/LongStream;)[J
...
.method public static final toList(Ljava/util/stream/Stream;)Ljava/util/List;
    ...
    .line 72
    invoke-static {}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m()Ljava/util/stream/Collector;

    move-result-object v0

    invoke-static {p0, v0}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/Stream;Ljava/util/stream/Collector;)Ljava/lang/Object;
