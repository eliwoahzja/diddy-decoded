...
.method public abstract getAppInfoOrBuilder()Lcom/uqm/crashsight/crashreport/common/info/SightPkg$AppInfoOrBuilder;
.end method
...
.method public abstract getAttachesOrBuilder(I)Lcom/uqm/crashsight/crashreport/common/info/SightPkg$AttachmentOrBuilder;
.end method

.method public abstract getAttachesOrBuilderList()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
...
.method public abstract getDeviceBootTime()J
.end method
...
.method public abstract getEhType()I
.end method
...
.method public abstract getLibInfosOrBuilder(I)Lcom/uqm/crashsight/crashreport/common/info/SightPkg$AppInfoOrBuilder;
.end method

.method public abstract getLibInfosOrBuilderList()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
...
.method public abstract getPidName()Ljava/lang/String;
.end method

.method public abstract getPidNameBytes()Lcom/uqm/crashsight/protobuf/ByteString;
.end method
...
.method public abstract getPluginsOrBuilder(I)Lcom/uqm/crashsight/crashreport/common/info/SightPkg$AppInfoOrBuilder;
.end method

.method public abstract getPluginsOrBuilderList()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
...
.method public abstract getServerSymbolize()Z
.end method

.method public abstract getSession()Lcom/uqm/crashsight/crashreport/common/info/SightPkg$AppSession;
.end method

.method public abstract getSessionOrBuilder()Lcom/uqm/crashsight/crashreport/common/info/SightPkg$AppSessionOrBuilder;
.end method

.method public abstract getStackBeginAddress()J
.end method

.method public abstract getStackData()Lcom/uqm/crashsight/protobuf/ByteString;
.end method

.method public abstract getTextCodeFragments(I)Lcom/uqm/crashsight/crashreport/common/info/SightPkg$MemoryData;
.end method

.method public abstract getTextCodeFragmentsCount()I
.end method

.method public abstract getTextCodeFragmentsList()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
...
.method public abstract getTextCodeFragmentsOrBuilder(I)Lcom/uqm/crashsight/crashreport/common/info/SightPkg$MemoryDataOrBuilder;
.end method

.method public abstract getTextCodeFragmentsOrBuilderList()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
