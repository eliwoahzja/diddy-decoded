...
.method public captureEvent(Lio/sentry/SentryEvent;Lio/sentry/Scope;Lio/sentry/Hint;)Lio/sentry/protocol/SentryId;
    ...
    .line 75
    const-string v3, "SentryEvent is required."

    invoke-static {p1, v3}, Lio/sentry/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v4, v3}, Lio/sentry/SentryOptions;->containsIgnoredExceptionForType(Ljava/lang/Throwable;)Z
    ...
    invoke-direct {p0, v0, v7, v3}, Lio/sentry/SentryClient;->processEvent(Lio/sentry/SentryEvent;Lio/sentry/Hint;Ljava/util/List;)Lio/sentry/SentryEvent;
    ...
    .line 124
    invoke-interface {v3, v4, v5}, Lio/sentry/clientreport/IClientReportRecorder;->recordLostEvent(Lio/sentry/clientreport/DiscardReason;Lio/sentry/DataCategory;)V
    ...
    .line 134
    new-instance v4, Lio/sentry/SentryClient$$ExternalSyntheticLambda0;

    invoke-direct {v4}, Lio/sentry/SentryClient$$ExternalSyntheticLambda0;-><init>()V

    invoke-virtual {p2, v4}, Lio/sentry/Scope;->withSession(Lio/sentry/Scope$IWithSession;)Lio/sentry/Session;
    ...
    .line 141
    iget-object v6, p0, Lio/sentry/SentryClient;->options:Lio/sentry/SentryOptions;
    ...
    invoke-interface {v6, v10, v0, v11}, Lio/sentry/ILogger;->log(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    sget-object v6, Lio/sentry/clientreport/DiscardReason;->SAMPLE_RATE:Lio/sentry/clientreport/DiscardReason;

    sget-object v10, Lio/sentry/DataCategory;->Error:Lio/sentry/DataCategory;

    .line 149
    invoke-interface {v0, v6, v10}, Lio/sentry/clientreport/IClientReportRecorder;->recordLostEvent(Lio/sentry/clientreport/DiscardReason;Lio/sentry/DataCategory;)V
    ...
    :cond_9
    :goto_2
    invoke-direct {p0, v4, v5}, Lio/sentry/SentryClient;->shouldSendSessionUpdateForDroppedEvent(Lio/sentry/Session;Lio/sentry/Session;)Z
    ...
    invoke-interface {v2, v0, v7}, Lio/sentry/transport/ITransport;->send(Lio/sentry/SentryEnvelope;Lio/sentry/Hint;)V
    :try_end_0
...
.method public captureTransaction(Lio/sentry/protocol/SentryTransaction;Lio/sentry/TraceContext;Lio/sentry/Scope;Lio/sentry/Hint;Lio/sentry/ProfilingTraceData;)Lio/sentry/protocol/SentryId;
    ...
    .line 532
    invoke-direct {p0, p3, v7}, Lio/sentry/SentryClient;->addScopeAttachmentsToHint(Lio/sentry/Scope;Lio/sentry/Hint;)V
    ...
    invoke-direct {p0, v0, v7, v2}, Lio/sentry/SentryClient;->processTransaction(Lio/sentry/protocol/SentryTransaction;Lio/sentry/Hint;Ljava/util/List;)Lio/sentry/protocol/SentryTransaction;
...
.method public captureUserFeedback(Lio/sentry/UserFeedback;)V
    ...
    invoke-interface {v2, v3, v0, p1, v4}, Lio/sentry/ILogger;->log(Lio/sentry/SentryLevel;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
